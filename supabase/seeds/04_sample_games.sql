...
-- Note: Les colonnes developer/publisher ont été supprimées - voir migration 004_companies_structure
-- Note: Les colonnes launch_price/current_price/currency ont été supprimées - voir migration 009_cleanup_old_price_schema
-- Note: Les colonnes pegi_rating/esrb_rating ont été supprimées - voir migration 012_migrate_existing_ratings
-- Note: La colonne media a été supprimée - voir migration 003_media_tables
-- Les relations développeur/éditeur sont maintenant gérées via la table game_companies (voir seed 08)
-- Les prix sont maintenant gérés via la table game_prices (voir seed 10)
-- Les classifications sont maintenant gérées via la table game_ratings (voir seed 12)
-- Les médias sont maintenant gérés via cover_image_url, background_color, background_image_url
