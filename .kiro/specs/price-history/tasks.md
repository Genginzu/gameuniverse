...
- [ ] 1. Créer la migration SQL pour la table `game_price_history` et le trigger
  - [ ] 1.1 Créer le fichier de migration `supabase/migrations/20240221000001_game_price_history.sql`
  ...
  - [ ] 1.2 Créer le trigger `record_price_history` sur `game_prices`
...
- [ ] 2. Créer les fonctions SQL de récupération d'historique
  - [ ] 2.1 Créer le fichier de migration `supabase/migrations/20240221000002_price_history_functions.sql`
...
- [ ] 3. Créer les types TypeScript et le service d'historique de prix
  - [ ] 3.1 Créer le fichier de types `src/types/price-history.ts`
  ...
  - [ ] 3.2 Créer le service `src/lib/services/priceHistoryService.ts`
  ...
  - [ ]* 3.3 Écrire les tests property-based pour le service d'historique
  ...
  - [ ]* 3.4 Écrire les tests unitaires pour le service d'historique
...
- [ ] 4. Checkpoint — Vérifier que la couche données et service fonctionne
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Créer l'API route d'historique de prix
  - [ ] 5.1 Créer `src/app/api/games/[slug]/price-history/route.ts`
  ...
  - [ ]* 5.2 Écrire les tests unitaires pour l'API route
...
- [ ] 6. Créer le hook et les composants UI
  - [ ] 6.1 Créer le hook `src/hooks/usePriceHistory.ts`
  ...
  - [ ] 6.2 Installer Recharts et créer le composant `src/components/games/details/PriceHistoryChart.tsx`
  ...
  - [ ] 6.3 Créer le composant `src/components/games/details/PriceHistoryStats.tsx`
  ...
  - [ ] 6.4 Créer le composant `src/components/games/details/PriceHistoryFilters.tsx`
  ...
  - [ ] 6.5 Créer le composant orchestrateur `src/components/games/details/PriceHistoryTab.tsx`
...
- [ ] 7. Intégrer l'onglet historique de prix dans la page de détail du jeu
  - [ ] 7.1 Modifier `GameDetailsTabs` pour ajouter l'onglet "Prix"
  ...
  - [ ] 7.2 Ajouter les clés de traduction i18n pour l'onglet historique de prix
...
- [ ] 11. README de la fonctionnalité
  - [ ] 11.1 Créer `docs/README_PRICE_HISTORY.md`
