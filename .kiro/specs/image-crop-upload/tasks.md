...
- [ ] 1. Définir les types et constantes de crop
  - [ ] 1.1 Créer `src/types/crop.ts` avec les interfaces et constantes
    ...
    - _Exigences : 6.1, 6.2_
  - [ ] 1.2 Ajouter les constantes de sortie dans `src/types/upload.ts`
...
- [ ] 2. Implémenter l'utilitaire `cropCanvas`
  - [ ] 2.1 Créer `src/lib/utils/cropCanvas.ts`
  ...
  - [ ]* 2.2 Écrire les tests unitaires pour `cropCanvas`
  ...
  - [ ]* 2.3 Écrire le test property-based P4 : Dimensions de sortie conformes au contexte
  ...
  - [ ]* 2.4 Écrire le test property-based P5 : cropCanvas produit un Blob WebP valide
    - Fichier : `test/unit/lib/utils/cropCanvas.property.test.ts`
...
- [ ] 3. Implémenter le hook `useCropEditor`
  - [ ] 3.1 Créer `src/hooks/useCropEditor.ts`
  ...
  - [ ]* 3.2 Écrire les tests unitaires pour `useCropEditor`
  ...
  - [ ]* 3.3 Écrire le test property-based P1 : Clamping de position — pas de zone vide
  ...
  - [ ]* 3.4 Écrire le test property-based P2 : Bornes du zoom [1, 3]
    - Fichier : `test/unit/hooks/useCropEditor.property.test.ts`
  ...
  - [ ]* 3.5 Écrire le test property-based P3 : Stabilité du centre lors du zoom
    - Fichier : `test/unit/hooks/useCropEditor.property.test.ts`
...
- [ ] 4. Checkpoint — Vérification des fondations
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implémenter le composant `CropEditor`
  - [ ] 5.1 Créer `src/components/shared/CropEditor.tsx`
  ...
  - [ ]* 5.2 Écrire les tests unitaires pour `CropEditor`
...
- [ ] 6. Modifier `useImageUpload` pour accepter Blob
  - [ ] 6.1 Adapter `src/hooks/useImageUpload.ts`
  ...
  - [ ]* 6.2 Écrire les tests unitaires pour les modifications de `useImageUpload`
...
- [ ] 7. Intégrer `CropEditor` dans `ImageUploader`
  - [ ] 7.1 Modifier `src/components/shared/ImageUploader.tsx`
  ...
  - [ ]* 7.2 Écrire les tests unitaires pour l'intégration dans `ImageUploader`
...
- [ ] 8. Ajouter les traductions i18n FR et EN
  - [ ] 8.1 Ajouter les clés `upload.crop.*` dans `src/messages/fr.json` et `src/messages/en.json`
    ...
    - _Exigences : 9.1, 9.2_
  - [ ]* 8.2 Écrire le test property-based P7 : Synchronisation des clés FR/EN
...
- [ ] 12. README de la fonctionnalité
  - [ ] 12.1 Créer `docs/README_image_crop_upload.md`
