...
- [ ] 1. Migration RLS et types de base
...
- [ ] 2. Routes API admin reviews
  ...
  - [ ] 2.2 Créer `src/app/api/admin/reviews/[id]/route.ts` (GET, PUT, DELETE)
...
- [ ] 3. Checkpoint — Vérifier les routes API
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Hook et composants admin
  - [ ] 4.1 Créer le hook `src/hooks/useAdminReviews.ts`
    - Suivre le pattern de `useAdminGames` : fetch paginé, delete, refetch
    - Gérer les états loading, error, pagination
    - _Requirements: 1.1, 3.2, 3.3_
  - [ ] 4.2 Créer `src/components/admin/reviews/AdminReviewsTable.tsx`
  ...
  - [ ] 4.3 Créer `src/components/admin/reviews/DeleteReviewDialog.tsx`
  ...
  - [ ] 4.4 Créer `src/components/admin/reviews/AdminReviewForm.tsx`
...
- [ ] 5. Pages admin
  - [ ] 5.1 Créer `src/app/[locale]/admin/reviews/page.tsx`
  ...
  - [ ] 5.2 Créer `src/app/[locale]/admin/reviews/[id]/edit/page.tsx`
...
- [ ] 6. Ajouter le lien "Avis" dans la navigation admin
  - Ajouter l'entrée dans le layout/sidebar admin pour accéder à
    `/admin/reviews`
  - _Requirements: 1.1_

- [ ] 7. Checkpoint — Vérifier l'intégration UI
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Tests
  - [ ] 8.1 Écrire les tests unitaires pour `adminReviewQuerySchema`
    ...
    - _Requirements: 1.1_
  - [ ] 8.2 Écrire le test property-based pour la validation des paramètres de
        requête
    - **Property 1: Pagination correcte**
    - **Validates: Requirements 1.1**
    - Emplacement :
      `test/unit/lib/validations/admin-review-query.property.test.ts`
  - [ ] 8.3 Écrire les tests isolés pour les routes API admin reviews
  ...
  - [ ] 8.4 Écrire le test property-based pour le rejet d'accès non-admin
    - **Property 7: Rejet d'accès non-admin**
    - **Validates: Requirements 4.1, 4.2**
    - Emplacement : `test/isolated/api/admin/reviews.property.test.ts`
  - [ ] 8.5 Écrire les tests unitaires pour les composants admin reviews
...
- [ ] 10. README de la fonctionnalité
  - [ ] 10.1 Créer `docs/README_ADMIN_REVIEW_MANAGEMENT.md`
  - [ ] 10.2 Documenter la fonctionnalité : description, accès (routes/URLs),
