...
- [x] 1. Create settings page and base structure
  - [x] 1.1 Create settings page at `src/app/[locale]/settings/page.tsx`
...
- [x] 6. Integration and final touches
  - [x] 6.1 Wire all components in SettingsContent
  ...
  - [x] 6.3 Create SettingsSkeleton component for loading state
