...
- [x] 1. Create shared types and API response models
  - [x] 1.1 Create `src/types/global-search.ts` with `GlobalSearchRequest`, `GlobalSearchResponse`, `GlobalSearchGameItem`, `GlobalSearchCharacterItem`, `GlobalSearchPlayerItem`, and `GlobalSearchResult` interfaces
    - _Requirements: 8.1, 8.2, 8.3_

- [x] 2. Implement GlobalSearchService
  - [x] 2.1 Create `src/lib/services/globalSearchService.ts` with `GlobalSearchService.search()` method
  ...
  - [x] 2.2 Implement `GlobalSearchService.toGlobalSearchResponse()` transformation method
  ...
  - [x] 2.3 Write property tests for GlobalSearchService
...
- [x] 3. Create Global Search API route
  - [x] 3.1 Create `src/app/api/search/global/route.ts` GET endpoint
  ...
  - [x] 3.2 Write property test for short query rejection
...
- [x] 5. Implement useGlobalSearch hook
  - [x] 5.1 Create `src/hooks/useGlobalSearch.ts`
  ...
  - [x] 5.2 Write property tests for useGlobalSearch utilities
...
- [x] 6. Implement GlobalSearchBar and dropdown components
  - [x] 6.1 Create `src/components/shared/GlobalSearchGameItem.tsx`
    ...
    - _Requirements: 6.1_
  - [x] 6.2 Create `src/components/shared/GlobalSearchCharacterItem.tsx`
    - Render character result: main image, name, role, primary game
    - Accept `isActive` prop for keyboard highlight
    - _Requirements: 6.2_
  - [x] 6.3 Create `src/components/shared/GlobalSearchPlayerItem.tsx`
    - Render player result: avatar, username
    - Accept `isActive` prop for keyboard highlight
    - _Requirements: 6.3_
  - [x] 6.4 Create `src/components/shared/GlobalSearchDropdown.tsx`
  ...
  - [x] 6.5 Create `src/components/shared/GlobalSearchBar.tsx`
...
- [x] 7. Add i18n translations and integrate into layout
  - [x] 7.1 Add `globalSearch` keys to `src/messages/fr.json` and `src/messages/en.json`
    - Add placeholder, noResults, loading, category headers, source labels
    - _Requirements: 7.3_
  - [x] 7.2 Replace `GameSearchBar` with `GlobalSearchBar` in `DashboardHeader`
...
- [x] 11. README de la fonctionnalité
  - [x] 11.1 Créer `docs/README_GLOBAL_SEARCH.md`
