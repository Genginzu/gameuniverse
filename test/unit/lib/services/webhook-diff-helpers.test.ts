...
import { igdbCoverUrl, igdb1080pUrl, unixToDate, normalizeDate, sorted, fetchLocalGenres } from '@/lib/services/webhook-diff-helpers';

describe('webhook-diff-helpers pure functions', () => {
  it('igdbCoverUrl builds correct URL', () => {
    expect(igdbCoverUrl('abc123')).toBe('https://images.igdb.com/igdb/image/upload/t_cover_big/abc123.jpg');
  });
