...
vi.mock('@/lib/validations/admin-translation', () => ({
  saveTranslationBodySchema: {
    safeParse: vi.fn(() => ({ success: true, data: { entityType: 'games', entityId: 'e1', targetLang: 'en', translations: { title: 'Test' } } })),
  },
}));
...
describe('PUT /api/admin/translations/save', () => {
  ...
  test('returns 403 when not admin', async () => {
    ...
    const req = new NextRequest('http://localhost/api/admin/translations/save', { method: 'PUT', body: '{}' });
