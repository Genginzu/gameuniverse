...
describe('GET /api/admin/age-classifications/[id]/ratings/[ratingId]', () => {
  ...
  test('returns 200 with rating', async () => {
    ...
    mockFrom.mockImplementation(() => {
      callCount++;
      if (callCount === 1) return chainMock({ id: 'r1', rating_system_id: 'sys1', code: '3', display_name: 'PEGI 3', minimum_age: 3, color_hex: null, icon_url: null, sort_order: 0, rating_translations: [] });
