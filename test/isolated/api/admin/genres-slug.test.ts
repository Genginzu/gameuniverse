      ...
      mockSupabaseFrom = mock((table: string) => {
        if (table === "genres") {
          return {
            select: mock(() => ({
              eq: mock(() => ({
                single: mock(() => Promise.resolve({ data: sampleGenre, error: null })),
              })),
            })),
          };
        }
      ...
      mockSupabaseFrom = mock((table: string) => {
        if (table === "genres") {
          ...
          return {
            select: mock(() => ({
              eq: mock(() => ({
                single: mock(() => Promise.resolve({ data: updatedGenre, error: null })),
              })),
            })),
          };
        }
      ...
      mockSupabaseFrom = mock((table: string) => {
        if (table === "genres") {
          ...
          return {
            select: mock(() => ({
              eq: mock(() => ({
                single: mock(() => Promise.resolve({ data: { id: "genre-uuid-1" }, error: null })),
              })),
            })),
          };
        }
      ...
      mockSupabaseFrom = mock((table: string) => {
        if (table === "genres") {
          return {
            ...
            delete: mock(() => {
              genreDeleted = true;
              return { eq: mock(() => Promise.resolve({ error: null })) };
            }),
          };
        }
        if (table === "game_genres") {
    ...
    test("returns 500 when translation delete fails", async () => {
      mockSupabaseFrom = mock((table: string) => {
        ...
        if (table === "genre_translations") {
          return {
            delete: mock(() => ({
              eq: mock(() => Promise.resolve({ error: { message: "delete error" } })),
            })),
          };
        }
        return {};
