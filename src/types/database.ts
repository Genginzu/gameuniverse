...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      games: {
        Row: {
          ...
          cover_image_url: string | null;
          created_at: string | null;
          hybrid_popularity_score: number | null;
          id: string;
          igdb_id: number | null;
          igdb_pop_playing: number | null;
          igdb_pop_updated_at: string | null;
          igdb_pop_visits: number | null;
          igdb_pop_want_to_play: number | null;
      ...
      player_subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "player_subscriptions_subscriber_id_fkey";
          ...
          {
            foreignKeyName: "player_subscriptions_target_id_fkey";
            columns: ["target_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      compute_hybrid_popularity: {
        Args: {
          p_igdb_playing: number;
          p_igdb_visits: number;
          p_igdb_want: number;
