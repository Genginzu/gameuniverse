        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-medium transition-colors ${
              isActive
                ? "bg-palette-secondary-500/10 text-palette-secondary-600 ring-palette-secondary-500/30 dark:bg-palette-secondary-500/20 dark:text-palette-secondary-300 dark:ring-palette-secondary-500/40 ring-1"
