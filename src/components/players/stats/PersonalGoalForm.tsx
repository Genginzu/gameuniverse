    ...
    >
      ...
      <div className="mt-4 flex gap-2">
        <button
          ...
          className="from-neon-primary to-neon-secondary rounded-lg bg-linear-to-r px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:opacity-90 disabled:opacity-50"
        >
