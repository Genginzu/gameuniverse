...
export function PlayerReviewsSortSelect({ value, onChange }: PlayerReviewsSortSelectProps) {
  ...
  return (
    <select
      ...
      className="cursor-pointer rounded-xl border border-white/20 bg-white/40 px-4 py-2 text-sm font-medium text-gray-700 backdrop-blur-xl transition-all duration-300 hover:bg-white/60 focus:outline-none focus:ring-2 focus:ring-neon-violet/30 dark:border-slate-700/50 dark:bg-slate-800/50 dark:text-slate-200 dark:hover:bg-slate-700/60 dark:focus:ring-neon-violet/40"
    >
