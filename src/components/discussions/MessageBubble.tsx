      ...
      <div
        className={`max-w-[85%] px-3.5 py-2.5 transition-all duration-300 sm:max-w-[75%] sm:px-4 ${
          isOwn
            ...
            : "border-editorial-line rounded-2xl rounded-bl-md border bg-editorial-3 text-white shadow-[0_2px_10px_rgba(0,0,0,0.35)]"
        }`}
      ...
      >
        ...
        <span
          className={`mt-1 block text-[10px] ${
            isOwn ? "text-white/60" : "text-editorial-muted"
          }`}
