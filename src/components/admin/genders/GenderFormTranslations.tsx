...
export interface GenderFormTranslationsProps {
  form: UseFormReturn<GenderFormData>;
  supportedLanguages: SupportedLanguage[];
}

export function GenderFormTranslations({ form, supportedLanguages }: GenderFormTranslationsProps) {
  const t = useTranslations("admin.genders.form");
