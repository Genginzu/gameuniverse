...
function ImageField({
  ...
  return (
    <div className="space-y-3">
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <div className="flex gap-2">
              <FormControl>
                <Input type="url" placeholder={placeholder} {...field} value={field.value ?? ""} />
              </FormControl>
              <Button
                type="button"
                variant="outline"
      ...
      {imageUrl && (
        <div
          className={`relative ${imageHeight} rounded-xl border border-gray-200 dark:border-gray-700`}
        >
          <Image
            key={imageUrl}
            src={imageUrl}
