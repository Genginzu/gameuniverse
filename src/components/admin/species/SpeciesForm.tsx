...
import { SpeciesFormTranslations } from "./SpeciesFormTranslations";
...
export function SpeciesForm({
  ...
  const t = useTranslations("admin.species.form");
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6" noValidate>
        ...
        <SpeciesFormTranslations form={form} supportedLanguages={supportedLanguages} />
