      ...
      <td className="px-3 py-3" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="from-palette-secondary-500 to-palette-primary-500 inline-flex items-center gap-1 rounded-lg bg-linear-to-r px-2.5 py-1 text-xs font-medium text-white transition-all duration-300 hover:opacity-90 disabled:opacity-50"
          >
            {isTranslating ? (
          ...
          <button
            ...
            disabled={isTranslating}
            className="border-palette-secondary-500/30 text-palette-secondary-600 hover:bg-palette-secondary-50 dark:text-palette-secondary-400 dark:hover:bg-palette-secondary-900/20 inline-flex items-center gap-1 rounded-lg border px-2.5 py-1 text-xs font-medium transition-all duration-300 disabled:opacity-50"
          >
            {isTranslating ? (
              <Icon icon="mdi:loading" className="size-3.5 animate-spin" />
            ) : (
