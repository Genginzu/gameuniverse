  ...
  return (
    <div className="w-full shrink-0 lg:w-[320px]">
      <div className="sticky top-24 space-y-4">
        {/* Cover image */}
        <div className="group relative mx-auto max-w-[220px] overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg shadow-black/20 backdrop-blur-xl lg:max-w-[240px]">
        ...
        {/* Share button */}
        <button className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 py-3 text-sm font-medium text-slate-300 shadow-lg shadow-black/10 backdrop-blur-xl transition-colors will-change-transform hover:bg-white/10">
