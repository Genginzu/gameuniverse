  ...
  return (
    <div className="relative border-t border-gray-200 p-3 dark:border-white/10" ref={menuRef}>
      <button
        ...
        className="focus:ring-palette-primary-400/50 flex w-full items-center gap-3 rounded-lg px-2 py-2 transition-all hover:bg-black/5 focus:ring-2 focus:outline-hidden dark:hover:bg-white/10"
      >
        <div className="from-palette-primary-500 shadow-palette-primary-500/20 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-linear-to-br to-blue-500 shadow-lg">
