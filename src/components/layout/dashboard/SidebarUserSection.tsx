  ...
  return (
    <div className="relative border-t border-gray-200 p-3 dark:border-white/10" ref={menuRef}>
      <button
        ...
        className="flex w-full items-center gap-3 rounded-lg px-2 py-2 transition-all hover:bg-black/5 focus:outline-hidden focus:ring-2 focus:ring-violet-400/50 dark:hover:bg-white/10"
      >
