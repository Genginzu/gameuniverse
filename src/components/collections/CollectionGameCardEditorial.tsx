    ...
    <div className="group/card relative">
      ...
      {onEditNote && (
        <button
          ...
          className="pointer-events-none absolute top-2 left-2 z-[2] grid size-9 scale-90 place-items-center rounded-full border border-[rgba(var(--accent-rgb,var(--neon-primary)),0.4)] bg-[rgba(var(--accent-rgb,var(--neon-primary)),0.2)] text-[rgb(var(--accent-rgb,var(--neon-primary)))] opacity-0 backdrop-blur-md transition group-focus-within/card:pointer-events-auto group-focus-within/card:scale-100 group-focus-within/card:opacity-100 group-hover/card:pointer-events-auto group-hover/card:scale-100 group-hover/card:opacity-100 hover:border-[rgb(var(--accent-rgb,var(--neon-primary)))] hover:bg-[rgb(var(--accent-rgb,var(--neon-primary)))] hover:text-white focus-visible:scale-100 focus-visible:opacity-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[rgb(var(--accent-rgb,var(--neon-primary)))] pointer-coarse:pointer-events-auto pointer-coarse:scale-100 pointer-coarse:opacity-100"
