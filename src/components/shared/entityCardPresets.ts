...
export const gameCardConfig: EntityCardConfig<GameSummary> = {
  ...
  customHoverRenderer: (game, t) => {
    ...
    return React.createElement(React.Fragment, null,
      // Title
      React.createElement("h3", { className: "mb-2 line-clamp-2 text-lg font-bold text-white" }, game.title),
      
      // Description
      game.description && React.createElement("p", { className: "mb-3 line-clamp-2 text-sm leading-relaxed text-gray-200" }, game.description),
      
      // Developer & Publisher
      React.createElement("div", { className: "mb-3 space-y-1 text-xs" },
        React.createElement("div", { className: "flex items-center text-gray-300" },
          React.createElement("span", { className: "font-medium text-gray-400" }, t("developerShort"), ":"),
          React.createElement("span", { className: "ml-1 font-medium text-white" }, game.developer)
        ),
        game.publisher !== game.developer && React.createElement("div", { className: "flex items-center text-gray-300" },
          React.createElement("span", { className: "font-medium text-gray-400" }, t("publisherShort"), ":"),
          React.createElement("span", { className: "ml-1 font-medium text-white" }, game.publisher)
        )
      ),
      
      // Genres
      game.genres.length > 0 && React.createElement("div", { className: "mb-3 flex flex-wrap gap-1" },
        ...
        game.genres.length > 2 && React.createElement(Badge, {
          variant: "outline",
      ...
      // Release Date
      game.releaseDate && React.createElement("div", { className: "flex items-center text-xs text-gray-300" },
        React.createElement("svg", { className: "mr-1 h-3 w-3", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
  ...
  customHoverRenderer: (player, t) => {
    ...
    return React.createElement("div", { className: "w-full" },
      React.createElement("div", { className: "flex items-center justify-between" },
        ...
        React.createElement("span", { className: "flex items-center text-xs text-gray-300" },
          React.createElement("svg", { className: "mr-1 h-3 w-3", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
            React.createElement("path", {
              strokeLinecap: "round",
              strokeLinejoin: "round",
...
export const characterCardConfig: EntityCardConfig<CharacterSummary> = {
  ...
  customHoverRenderer: (character, t) => {
    return React.createElement(React.Fragment, null,
      // Name
      React.createElement("h3", { className: "mb-2 line-clamp-2 text-lg font-bold text-white" }, character.name),
      
      // Description
      character.description && React.createElement("p", { className: "mb-3 line-clamp-2 text-sm leading-relaxed text-gray-200" }, character.description),
      
      // Primary Game
      React.createElement("div", { className: "mb-3 space-y-1 text-xs" },
        React.createElement("div", { className: "flex items-center text-gray-300" },
          React.createElement("span", { className: "font-medium text-gray-400" }, t("game")),
          React.createElement("span", { className: "ml-1 font-medium text-white" }, character.primaryGame)
        )
      ),
      
      // Games count
      React.createElement("div", { className: "flex items-center text-xs text-gray-300" },
        React.createElement("svg", { className: "mr-1 h-3 w-3", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" },
          React.createElement("path", {
            strokeLinecap: "round",
            strokeLinejoin: "round",
