    ...
    >
      ...
      {action && (
        <button
          ...
          className="mt-4 rounded-lg bg-linear-to-r from-cyan-500 to-violet-500 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:from-cyan-600 hover:to-violet-600 hover:shadow-lg"
        >
          {action.label}
        </button>
      )}
