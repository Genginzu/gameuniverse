...
const BANNER_CONFIG: Record<string, BannerConfig> = {
  ...
  "/esport/calendar": { icon: "mdi:calendar-month", titleKey: "esportCalendar", descriptionKey: "esportCalendarDesc" },
  "/esport/tournaments": { icon: "mdi:trophy-outline", titleKey: "esportTournaments", descriptionKey: "esportTournamentsDesc" },
