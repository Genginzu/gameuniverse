...
export const roleTranslationSchema = z.object({
...
export type RoleFormData = z.infer<typeof adminRoleFormSchema>;
export type RoleTranslationData = z.infer<typeof roleTranslationSchema>;
