...
Les #tags dans les posts sont désormais cliquables et mènent vers une page dédiée listant tous les posts publics (cross-joueurs) ayant ce tag. Les pills de tags statiques sous le contenu ont été supprimées — les tags sont visibles inline dans le texte, à l'endroit où le joueur les a écrits.
...
- Migration `20260421000001_index_post_tags_tag.sql` appliquée (index sur `post_tags.tag`)
...
- La page de tag affiche tous les posts publics avec ce tag, paginés (20 par page)
- Chaque post affiche l'auteur (nom + avatar) puisque les posts proviennent de différents joueurs
