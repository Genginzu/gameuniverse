...
-- Companies
INSERT INTO companies (name, slug, company_type) VALUES ('Nutting Associates', 'nutting-associates', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Atari', 'atari', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Michael Irrgang', 'michael-irrgang', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Computer Recreations, Inc.', 'computer-recreations-inc', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('MECC', 'mecc', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Mike Mayfield', 'mike-mayfield', 'developer') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('imlac-pds-1', 111) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('cdc-cyber-70', 109) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('sds-sigma-7', 106) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('computer-space', 11245, '1971-11-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6s4s.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/ar46jg.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('freeway-crossing-program', 351414, '1971-12-31', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/coa2eb.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/scxqld.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('galaxy-game', 11396, '1971-09-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6shk.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/vvjvaguq1fnqrqysxmb7.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('the-oregon-trail', 11325, '1971-12-03', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6k5q.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/scv9o4.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('baseball--3', 11412, '1971-12-31', NULL, NULL, NULL, NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('star-trek--1', 11485, '1971-07-01', 50, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6t8s.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/v5mnvubblilwfvt2y1h5.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
INSERT INTO game_translations (game_id, language_code, title, description) SELECT id, 'en', 'Star Trek', 'Star Trek is a text-based strategy video game based on the Star Trek television series (1966–69) and originally released in 1971.
