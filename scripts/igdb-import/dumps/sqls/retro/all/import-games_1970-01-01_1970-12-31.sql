...
-- Generated: 2026-03-28T22:51:29.561Z
-- Games: 3
...
-- Companies
INSERT INTO companies (name, slug, company_type) VALUES ('s1axter', 's1axter', 'developer') ON CONFLICT DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Chris Gaylo', 'chris-gaylo', 'developer') ON CONFLICT DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('John Horton Conway', 'john-horton-conway', 'developer') ON CONFLICT DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Scientific American', 'scientific-american', 'developer') ON CONFLICT DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Sega Entertainment', 'sega-entertainment', 'developer') ON CONFLICT DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('call-a-computer-time-shared-mainframe-computer-system', 107) ON CONFLICT DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('pdp-7', 103) ON CONFLICT DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('highnoon', 11304, '1970-09-12', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co4zn0.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/sc7kp9.jpg', NOW()) ON CONFLICT DO NOTHING;
INSERT INTO game_translations (game_id, language_code, title, description) SELECT id, 'en', 'Highnoon', 'Highnoon is a BASIC game developed by Christopher Gaylo from Syosset High School, New York in early 1970 on a timeshared mainframe computer. The game is single-player and set in the Wild West in 1889. The objective of the game is a showdown between the player and Black Bart. The status of the game, actions available and results of each action are written to the system console as textual descriptions. Turns are taken to either move closer, run, or shoot. Both the player and Bart have four shots and the odds of hitting each other increase as the player closes the 100 paces between each.' FROM games WHERE igdb_id = 11304 ON CONFLICT (game_id, language_code) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('jet-rocket', 56115, '1970-07-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/t4svz18epdjvxayq9xnm.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/ar5eyd.jpg', NOW()) ON CONFLICT DO NOTHING;
