...
-- Companies
INSERT INTO companies (name, slug, company_type) VALUES ('Midway', 'midway', 'developer') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO companies (name, slug, company_type) VALUES ('Paul Resch', 'paul-resch', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Larry Kemp', 'larry-kemp', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Eric Hagstrom', 'eric-hagstrom', 'developer') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('gun-fight', 85868, '1975-11-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co3tmc.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/sc5s1b.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('orthanc', 146634, '1975-12-31', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co2z7j.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/sc9fbq.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
