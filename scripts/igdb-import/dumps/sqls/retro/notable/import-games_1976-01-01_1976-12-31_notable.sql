...
INSERT INTO companies (name, slug, company_type) VALUES ('HAL Laboratory', 'hal-laboratory', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('General Instrument Microelectronic', 'general-instrument-microelectronic', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('ASCII Corporation', 'ascii-corporation', 'developer') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO companies (name, slug, company_type) VALUES ('Jim Battin', 'jim-battin', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Kevet Duncombe', 'kevet-duncombe', 'developer') ON CONFLICT (slug) DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Will Crowther', 'will-crowther', 'developer') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('ay-3-8606', 147) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('death-race', 8561, '1976-04-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co2kvz.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/sc8rv7.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('night-driver', 18649, '1976-10-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6wof.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/ar8v3.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('breakout', 2754, '1976-05-13', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co94iu.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/ar3nqb.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('blockade', 18118, '1976-10-01', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/qerr6aledcvu6ilnzpkr.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/scp3qk.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('moria', 77304, '1976-03-31', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co2z9t.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/sc9fwn.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('colossal-cave-adventure', 25115, '1976-03-31', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6zm7.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/sco86s.jpg', NOW()) ON CONFLICT (igdb_id) DO NOTHING;
