...
-- Companies
INSERT INTO companies (name, slug, company_type) VALUES ('Gregory Yob', 'gregory-yob', 'developer') ON CONFLICT DO NOTHING;
INSERT INTO companies (name, slug, company_type) VALUES ('Kevin Kenney', 'kevin-kenney', 'developer') ON CONFLICT DO NOTHING;
...
INSERT INTO companies (name, slug, company_type) VALUES ('Jack Burness', 'jack-burness', 'developer') ON CONFLICT DO NOTHING;
...
-- Platforms
INSERT INTO platforms (slug, igdb_id) VALUES ('microcomputer', 112) ON CONFLICT DO NOTHING;
...
INSERT INTO platforms (slug, igdb_id) VALUES ('dec-gt40', 98) ON CONFLICT DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('hunt-the-wumpus', 11498, '1973-03-31', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co8c7p.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/ar2zm0.jpg', NOW()) ON CONFLICT DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('empire--1', 11518, '1973-03-31', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6tci.jpg', NULL, NOW()) ON CONFLICT DO NOTHING;
...
INSERT INTO games (slug, igdb_id, release_date, metascore, cover_image_url, background_image_url, last_synced_at) VALUES ('moonlander', 9129, '1973-02-25', NULL, 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6tcd.jpg', 'https://images.igdb.com/igdb/image/upload/t_1080p/scnfua.jpg', NOW()) ON CONFLICT DO NOTHING;
INSERT INTO game_translations (game_id, language_code, title, description) SELECT id, 'en', 'Moonlander', 'Moonlander (also known as Lunar Lander) is an early computer game made for the DEC GT40 computer and is the first graphical game in the lunar landing simulator subgenre, as well as the first one in real-time. It is notable for being the first video game with an Easter egg, a lone McDonalds on the moon''s surface that can be interacted with or destroyed.' FROM games WHERE igdb_id = 9129 ON CONFLICT (game_id, language_code) DO NOTHING;
