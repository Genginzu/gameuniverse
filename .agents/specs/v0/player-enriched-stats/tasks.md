...
- [x] 1. Types et migration base de données
  - [x] 1.1 Créer le fichier de types `src/types/player-stats.ts`
  ...
  - [x] 1.2 Créer la migration `supabase/migrations/20240227000001_player_stats_privacy.sql`
...
- [x] 2. Service de calcul des statistiques
  - [x] 2.1 Créer `src/lib/services/playerStatsService.ts` — méthodes `fetchEnrichedStats` et `computeFavoriteGenre`
  ...
  - [x] 2.2 Écrire le test property pour la somme du temps de jeu total
    - **Property 1 : Somme du temps de jeu total**
    - **Validates: Requirements 1.1**

  - [x] 2.3 Écrire le test property pour la précision décimale
    - **Property 2 : Précision décimale du temps de jeu**
    - **Validates: Requirements 1.3**

  - [x] 2.4 Écrire le test property pour le calcul du genre favori
    - **Property 3 : Calcul du genre favori avec pondération multi-genre**
    - **Validates: Requirements 2.1, 2.2, 2.4**

  - [x] 2.5 Écrire le test property pour le comptage des reviews
    - **Property 4 : Comptage des reviews et note moyenne**
    - **Validates: Requirements 3.1, 3.3**

  - [x] 2.6 Écrire le test property pour le formatage des nombres
    - **Property 5 : Formatage des nombres selon la locale**
    - **Validates: Requirements 4.4**

- [x] 3. Service de calcul du résumé annuel
  - [x] 3.1 Ajouter les méthodes `fetchYearInReview`, `fetchAvailableYears`, `computeMostActiveMonth` au `PlayerStatsService`
  ...
  - [x] 3.2 Écrire le test property pour le filtrage par année
    - **Property 6 : Filtrage par année pour le résumé annuel**
    - **Validates: Requirements 5.1**

  - [x] 3.3 Écrire le test property pour le mois le plus actif
...
- [x] 5. Routes API
  - [x] 5.1 Créer `src/app/api/players/[id]/stats/route.ts`
  ...
  - [x] 5.2 Créer `src/app/api/players/[id]/year/[year]/route.ts`
  ...
  - [x] 5.3 Écrire les tests unitaires pour les routes API
...
- [x] 6. Composants UI — Statistiques enrichies
  - [x] 6.1 Créer `src/components/players/PlayerEnrichedStats.tsx`
  ...
  - [x] 6.2 Créer `src/components/players/YearInReviewLink.tsx`
  ...
  - [x] 6.3 Écrire le test property pour la résolution du lien vers l'année
    - **Property 8 : Résolution du lien vers l'année**
    - **Validates: Requirements 7.2**

  - [x] 6.4 Intégrer `PlayerEnrichedStats` et `YearInReviewLink` dans `PlayerDetailsContent.tsx`
  ...
  - [x] 6.5 Écrire le test property pour la visibilité des statistiques
    - **Property 9 : Visibilité des statistiques selon la confidentialité**
    - **Validates: Requirements 8.2, 8.3**

- [x] 7. Page Résumé Annuel
  - [x] 7.1 Créer `src/app/[locale]/players/[id]/year/[year]/page.tsx`
  ...
  - [x] 7.2 Créer `src/components/players/YearInReviewContent.tsx`
...
- [x] 8. Internationalisation
  - [x] 8.1 Ajouter les clés de traduction dans `src/messages/fr.json` et `src/messages/en.json`
...
- [x] 12. README de la fonctionnalité
  - [x] 12.1 Créer `docs/README_PLAYER_ENRICHED_STATS.md`
